...
# Header
# -------------------------------------------------------------------------
# - Test code : 0316B-LockManagmentExample02
...
Feature:  0316B-LockManagmentExample02

    Scenario: 0316B0 - Login scenario
    ...
    Scenario: 0316B1 - Lock management - Add lock LCK_GESBIC
        And the user adds the lock entry "LCK_GESBIC"


    Scenario: 0316B2 - Lock management - Modify customer invoice
    ...
    Scenario: 0316B3 - Lock management - Remove lock LCK_GESBIC
        And the user removes the lock entry "LCK_GESBIC"


    Scenario: 0316B4 - Logout scenario
